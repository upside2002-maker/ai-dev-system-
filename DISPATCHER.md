...
| TL Astro | вкладка astro | свободен; BA-аналитика блога Марины **сдана 2026-05-21** (с UPDATE-2 и UPDATE-3 — Метрика дала картину «канал=SEO-блог, 60% трафика из поиска», топ-формула «Транзит планеты Х по дому Y» на 144 поста, дыра в воронке на astrologikurs.tilda.ws). Финальный отчёт `research/dzen-blog-analysis-2026-05-21.md` (51 КБ). Обновлённая выдержка для Марины — `dzen-marina-summary-2026-05-22.md`. Ждёт решения Owner'а/Марины. |
