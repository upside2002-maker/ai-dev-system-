...
- **Astro:** ждёт ответов Марины на 6 блокирующих вопросов перед запуском контент-движка + сайта-воронки (ТЗ `research/marina-content-funnel-spec-2026-05-22.md`). Параллельно — обновление BA-отчёта после поправки про ссылку в подвале.
