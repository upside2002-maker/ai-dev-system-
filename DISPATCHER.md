...
|------|-----|--------------|
| Admin | главный (Owner здесь) | **голос «Аида»: этапы 1 и 1.1 закрыты офлайн 2026-06-10** (живой тест №1: ключ 3/3 ✅, но завис вспомогательный слухач и «стоп» оглох → стоп переведён на vosk + сторож-перезапуск; Worker + Reviewer ACCEPT) — ждёт повторного живого теста Owner'а |
