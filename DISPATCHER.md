...
- **Astro:** ждёт **ревью Марины на 30 минут** — узнаёт ли себя в пилотном посту «Транзит Сатурна по 4 дому», попадает ли контент-план. Параллельно BA Astro правит §9 tech-rec под Yandex Cloud (было CF Pages). **Стартует Этап 2** — реализация лендинга по build-ТЗ (`astro/marketing-site/SITE_BUILD_TZ.md`), передано TL Astro 2026-06-02; деплой ждёт аккаунт Yandex Cloud от Owner'а.
