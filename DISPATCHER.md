...
| TL Sitka | вкладка sitka-office | **новая задача:** Owner принял рекомендацию форка парсера 2026-05-25. В ящике декомпозиция на 4 TASK'а (spike + форк + 2× P0-fixes + overlay refresh). Ориентир — рабочая неделя. |
