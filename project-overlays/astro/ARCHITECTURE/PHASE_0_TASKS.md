...
**Status @ astro:4937c00:** not-started (Phase 0.2) — see `architecture-drift-recon.md` §3
...
**Status @ astro:4937c00:** obsolete-by-evolution — see `architecture-drift-recon.md` §3
