...
Дата последнего обновления: 2026-06-05 (Planet Returns — **Phase D Python sampler + endpoint landed** — product `4bdf1b1`; `GET /persons/{id}/returns`; ОДИН subprocess-вызов Haskell, математики в Python НЕТ, в БД НЕ кэшируется; pytest 715/3/0; Phase A parity на Марине воспроизведён; 0 STOP).
