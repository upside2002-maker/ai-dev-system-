...
Дата последнего обновления: 2026-05-24 (Planet Returns — **Phase D CLOSED** — TL inline-verify APPROVE; `GET /persons/{id}/returns`; ОДИН subprocess-вызов, нет Python-math, не кэшируется; pytest 715/3/0; Phase A parity на Марине (Sun Δ~5с); 0 STOP. Эпик A-D готов; остаётся Phase E — UI+PDF).
