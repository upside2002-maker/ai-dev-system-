...
Дата последнего обновления: 2026-06-05 (Planet Returns — **Phase B Core landed** — Worker submitted; `Domain.TransitMath` вынесен бит-в-бит + новый `Domain.Returns`; cabal 275/0; 0 STOP triggers; **Reviewer REQUIRED**; product `a1e0c75` на main, backup pushed).
