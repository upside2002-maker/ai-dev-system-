...
Дата последнего обновления: 2026-05-24 (Planet Returns — **Phase B Core CLOSED** — TL-inline Reviewer APPROVE; `Domain.TransitMath` вынесен бит-в-бит + новый `Domain.Returns`; cabal 275/0 независимо воспроизведено; 0 STOP; product `a1e0c75` на main, backup pushed).
