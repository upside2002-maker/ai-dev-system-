...
Внутренний инструмент Марины для подготовки соляр-консультаций. **Программа Transit Section Recovery — CLOSED 2026-05-15.** **API PDF endpoint end-to-end repaired 2026-05-15** (TASK api-pdf-endpoint-end-to-end, Tier C + Reviewer-equivalent APPROVE). **Directions section — full list surfacing repaired 2026-05-16** (TASK directions-show-all-active, Tier C trivial, TL inline-verify path). **Transit Section — bottom interpretation parity + generic outer-cards fallback repaired 2026-05-16** (TASK transit-section-generic-output, Tier C, Worker self-review applied; TL spawns external Reviewer).

**Transit Section generic-output repair (TASK transit-section-generic-output, SUBMITTED 2026-05-16, awaiting TL accept-cascade):** Две независимые дыры закрыты для consultation 10 (Ольга, `case_label=None`, non-calibrated):
